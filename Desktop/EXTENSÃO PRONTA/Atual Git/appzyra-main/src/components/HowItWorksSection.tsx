import { ShoppingCart, Download, Zap } from "lucide-react";
import zyraExtensionPreview from "@/assets/zyra-extension-preview-new.png";

const steps = [{
  number: "01",
  icon: ShoppingCart,
  title: "Compre e Acesse",
  description: "Faça sua compra e receba acesso imediato a área de membros."
}, {
  number: "02",
  icon: Download,
  title: "Instale a Extensão",
  description: "Baixe e instale sua extensão no navegador Chrome."
}, {
  number: "03",
  icon: Zap,
  title: "Pronto para Usar",
  description: "Atualize a página e pronto! Já está 100% configurado e funcional."
}];
