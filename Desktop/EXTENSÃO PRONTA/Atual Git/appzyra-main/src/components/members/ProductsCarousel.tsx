...
const products: Product[] = [
  ...
  {
    id: "v0",
    name: "Extensão V0.dev",
    description: "Créditos ilimitados para criar interfaces com IA.",
    icon: extV0Icon,
    originalPrice: 14700,
    price: 6700,
    badge: "Beta",
    badgeColor: "primary",
    features: ["Créditos infinitos", "1 licença inclusa", "Atualizações grátis"],
  },
  {
    id: "manus",
    name: "Extensão Manus AI",
    description: "Créditos ilimitados para o agente autônomo Manus.",
    icon: extManusIcon,
    originalPrice: 14700,
    price: 6700,
    badge: "Beta",
