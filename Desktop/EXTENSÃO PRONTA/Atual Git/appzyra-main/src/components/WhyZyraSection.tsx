import { CreditCard, Shield, Infinity, Calendar, RefreshCcw, MessageCircle } from "lucide-react";
...
const benefits = [
  ...
  },
  {
    ...
    description: "Use o quanto precisar"
  },
  {
    icon: Calendar,
    title: "Funcionamento pleno desde novembro",
    description: "Testado e aprovado"
  },
  {
    icon: RefreshCcw,
  ...
  {
    icon: MessageCircle,
    title: "Total suporte no WhatsApp",
