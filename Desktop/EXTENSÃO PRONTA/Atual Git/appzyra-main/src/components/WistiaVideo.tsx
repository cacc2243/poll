...
const WistiaVideo = ({
  ...
  useEffect(() => {
    if (isReady && playerRef.current) {
      playerRef.current.playbackRate = 1.1;
    }
  }, [isReady]);

  // Tela inicial antes do vídeo
  if (!hasStarted) {
    return (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
            ...
            <div className="relative mb-4">
              ...
              <div 
                ...
                style={{
                  animation: 'pulse-scale 1.5s ease-in-out infinite 0.2s'
                }}
              />
              {/* Inner glow ring */}
              <div 
                ...
                style={{
                  animation: 'pulse-scale 1.5s ease-in-out infinite 0.4s'
                }}
              />
              <button
                type="button"
                className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-primary flex items-center justify-center transition-transform duration-300 group-hover:scale-110"
                style={{
                  boxShadow: '0 0 0 6px hsl(252 85% 67% / 0.3), 0 0 40px hsl(252 85% 67% / 0.5), 0 0 80px hsl(252 85% 67% / 0.3)',
            ...
            {/* Text */}
            <h3 className="text-foreground font-bold text-sm sm:text-base tracking-wide">
              {overlayTitle}
            </h3>
