...
serve(async (req) => {
  ...
  try {
    ...
    // IMPORTANTE: A validação de integridade é OPCIONAL
    // Se o array estiver vazio, a extensão funciona normalmente
    // 
    // COMO ADICIONAR HASH (quando quiser ativar):
    ...
    const EXPECTED_INTEGRITY_HASHES: string[] = [
      "6d6a1829a1379a732e6d2c7591b5efcc671174ed9192c48e65fb7fcd53386719"
    ];
