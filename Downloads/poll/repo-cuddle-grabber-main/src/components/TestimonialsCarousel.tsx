    ...
    <div className="mb-16 sm:mb-20">
      ...
      <div className="text-center mb-8 sm:mb-10">
        ...
        <p className="text-muted-foreground text-sm mt-2 max-w-md mx-auto">
          Conversas reais de pessoas que já usam o LovaPool
        </p>
      </div>
              ...
              <div
                ...
                style={{
                  background: index === selectedIndex 
                    ? "linear-gradient(135deg, #f56565 0%, #c53030 50%, #9b2c2c 100%)"
                    : "linear-gradient(135deg, rgba(197,48,48,0.3) 0%, rgba(155,44,44,0.2) 100%)"
                }}
              >
